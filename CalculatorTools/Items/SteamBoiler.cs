...
{
    public class SteamBoiler : ProductionEquipment
    {
        ...
        public SteamBoiler() : base()
        {
            TypeName = "Котёл паровой";
            _id = _currentId;
            _currentId++;
        }

        public SteamBoiler(string place, string name, string fuelType, double minCombustionHeat, double fuelConsumptionOnMaxPower,
        ...
        {
            return new XElement("SteamBoiler",
        ...
        {
            SteamBoiler boil = obj as SteamBoiler;
